...
export const PageAside = ({ children }: StrictPropsWithChildren) => {
  return (
    <aside className="hidden lg:block bg-[#F4F4F6] w-[300px] h-[100dvh] lg:pt-[84px] overflow-hidden lg:overflow-y-scroll lg:flex-shrink-0 lg:scroll-container lg:sticky lg:top-0">
      {children}
    </aside>
  );
};
